...
1. 从实验机拷 `WAM/FastWAM-LoRA/experiments/cross_embodiment/eval_relcond.py`
   与 `experiments/libero/` 工具层(或直接 rsync 整个 experiments/ 目录);
...
4. 15cm 格报 feasibility-adjusted(oracle 执行器天花板 77%,见
   note/experiment_log/2026-08-09_P2c_*.md);
5. 对照锚:base FastWAM 20/88/40/20(0/4/7/10cm 顺序为 100/88/40/20)、
