...
from fusionwam.shared.video_io import save_mp4
...
def create_wan22_model(
    ...
    from fusionwam.models.wan22 import Wan22Core
...
def create_wam_idm(
    ...
    from fusionwam.models.wam_idm import (
        WAMIDM,
    )
    ...
    return WAMIDM.from_wan22_pretrained(
        device=device,
        torch_dtype=model_dtype,
        model_id=model_id,
        tokenizer_model_id=tokenizer_model_id,
...
def create_fusion_model(
    ...
    **wam_joint_kwargs,
    ...
    semantic-expert (VLM) attachment. Hydra target for configs swapped in by
    train.py; extra keys are exactly the `fusion:` block of configs/stage1.yaml."""
    from fusionwam.models.fusion import FusionWAM

    model = create_wam_joint(model_cls=FusionWAM, **wam_joint_kwargs)
